...
async def ui_run_praisonai(config, topic, tools_dict):
    """Run Agent4ALL with the given configuration and topic."""
    logger = logging.getLogger(__name__)
    ...
    try:
        ...
        await cl.Message(
            content="Agent4ALL agents execution completed.",
            author="System"
        ).send()
