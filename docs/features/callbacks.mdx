...
<Tabs>
  <Tab title="Code">
    ```python
    from praisonaiagents import Agent, Task, Agent4ALLAgents, error_logs, register_display_callback
...
Agent4ALL Agents provides several async versions of display functions, prefixed with 'a'. Here's the complete list:
