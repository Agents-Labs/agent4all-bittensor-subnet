...
description: "Learn how to generate chain-of-thought reasoning data using Agent4ALL Agents."
icon: "brain"
---
...
<CardGroup>
  <Card title="Introduction" icon="book" href="/introduction">
    Learn more about Agent4ALL and its core concepts
  </Card>
  <Card title="Quick Start" icon="bolt" href="/quickstart">
    Get started with the basics of Agent4ALL
  </Card>
</CardGroup>