...
description: "Guide for creating and using multimodal AI agents in Agent4ALL for processing images, videos, and other media types"
icon: "images"
---
  ...
  <Tab title="No Code">
    <Steps>
        <Step title="Install Package">
            ...
            ```bash
            pip install agent4all opencv-python moviepy
            ```
        </Step>
        <Step title="Set API Key">
            Set your OpenAI API key as an environment variable in your terminal:
