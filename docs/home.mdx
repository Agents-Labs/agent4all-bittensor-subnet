...
title: "Praison AI"
sidebarTitle: "Home"
description: "Comprehensive guide to Agent4ALL - an AI Agents Framework with Self Reflection, combining Agent4ALL Agents, AG2 (Formerly AutoGen), and CrewAI for building multi-agent LLM systems"
icon: "house"
openGraph:
  url: "/"
seo:
...
<Tip>
  Agent4ALL combines Agent4ALL Agents, AG2 (Formerly AutoGen), and CrewAI into a low-code solution for building and managing multi-agent LLM systems, focusing on simplicity, customization, and efficient human-agent collaboration.
</Tip>
  ...
  <Tab title="No Code">
    <Steps>
      ...
      <Step title="Auto Mode">
        ```bash
        agent4all --auto create a movie script about Robots in Mars
        ```
