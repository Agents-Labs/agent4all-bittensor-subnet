---
title: "Agents"
description: "Understanding Agents in Agent4ALL"
icon: "user"
---

# Understanding Agents
Agents are the core building blocks of Agent4ALL. Each agent is an autonomous AI entity with specific roles, goals, and capabilities.
