---
title: "Agent4ALL Call"
description: "Guide to Agent4ALL's voice-based interaction feature enabling AI customer service through phone calls, including setup and tool integration"
icon: "phone"
---
...
Agent4ALL Call is a feature that enables voice-based interaction with AI models through phone calls. This functionality allows users to have natural conversations with AI agents over traditional phone lines.
...
agent4all call --public
```

### Step 2

Buy a number at [Agent4ALL Dashboard](https://dashboard.praison.ai/)

### Step 3

Enter the Public URL in the Agent4ALL Dashboard phone number field
...
- Integration with other Agent4ALL features
...
# Install Agent4ALL with the 'call' extra and ensure it's the latest version
RUN pip install --no-cache-dir --upgrade "agent4all[call]"
