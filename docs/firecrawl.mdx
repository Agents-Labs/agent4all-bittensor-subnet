---
title: "Firecrawl Agent4ALL Integration"
description: "Guide for integrating Firecrawl web scraping capabilities with Agent4ALL, including custom tool implementation for web page content extraction"
icon: "spider"
---

# Firecrawl Agent4ALL Integration
