...
description: "Guide for implementing and using custom tools in Agent4ALL with Google Colab, including examples of internet search and data processing tools"
icon: "wrench"
---
...
``` python
!pip install -Uq agent4all duckduckgo_search
```
