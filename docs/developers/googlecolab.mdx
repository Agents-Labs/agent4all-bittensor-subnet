...
description: "Guide for using Agent4ALL in Google Colab environments, with example code and configurations for agent-based tasks"
icon: "google"
---

<CardGroup cols={2}>
  <Card title="Basic Agent4ALL" icon="book">
    <a target="_blank" href="https://colab.research.google.com/github/MervinPraison/Agent4ALL/blob/main/cookbooks/agent4all-googlecolab.ipynb">
      <img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" />
    </a>
  </Card>
  <Card title="Agent4ALL with Tools" icon="screwdriver-wrench">
    <a target="_blank" href="https://colab.research.google.com/github/MervinPraison/Agent4ALL/blob/main/cookbooks/agent4all-tools-googlecolab.ipynb">
      <img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" />
    </a>
  </Card>
</CardGroup>
