...
description: "Guide for creating and using custom Python MCP servers with Agent4ALL agents"
icon: "python"
---
...
To use your custom MCP server with Agent4ALL agents, use the `MCP` class to specify the command to run your Python script:
