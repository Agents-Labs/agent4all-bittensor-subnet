---
title: "Smart City"
description: "Learn how to create AI agents for smart city resource management and optimization."
icon: "city"
---
...
```
    ...
    <Step title="Start Agents">
        Run your smart city management system:
        ```bash
        python app.py
        ```
    </Step>
...
<Card title="What is Smart City Management?" icon="question">
  Smart city management enables:
...
<CardGroup cols={2}>
  <Card title="Utility Monitoring" icon="gauge">
    Monitor city utilities:
    - Power consumption
    - Water usage
    - Traffic patterns
  </Card>
  ...
  <Card title="Resource Optimization" icon="sliders">
