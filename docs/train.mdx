---
title: "Agent4ALL Train"
description: "Guide for training and deploying models with Agent4ALL, including Hugging Face and Ollama integration with detailed configuration options"
icon: "dumbbell"
---
...
## Initilise agent4all train

```bash
agent4all train init
```
...
Note: Agent4ALL Train currently tested on Linux with 1 GPU. With pytorch-cuda=12.1
...
export WANDB_PROJECT=agent4all-test
export PRAISON_WANDB_RUN_NAME=agent4all-train  
```