---
title: 'Introduction'
description: 'Get started with Agent4ALL, an intelligent AI-powered tool'
icon: "hand-wave"
---

<Note>
  Agent4ALL is a low-code, centralized framework designed to simplify the creation and orchestration of multi-agent systems for various LLM applications.
</Note>

# Welcome to Agent4ALL

<Frame caption="Agent4ALL Framework Overview">
  ![Agent4ALL Overview](/images/agent4all-overview.png)
</Frame>
...
<Steps>
  <Step title="Installation">
    Follow our [Installation Guide](./installation) to set up Agent4ALL
  </Step>
