---
title: "Introduction"
description: "Welcome to Agent4ALL - The Next Generation AI Agent Framework"
icon: "book-open"
---

## What is Agent4ALL?

Agent4ALL is a powerful Multi-Agent Framework for building and deploying AI agents that can understand, reason, and execute complex tasks autonomously.
<CardGroup cols={1}>
  <Card title="Welcome to Agent4ALL" icon="wand-magic-sparkles">
  ...
  <Tab title="Code">
    <Steps>
      <Step title="Install Package">
        Install the Agent4ALL Agents package:
        ```bash
    ...
    <CodeGroup>
      ...
      # Run the agent
      agents = Agent4ALLAgents(agents=[summarise_agent])
      agents.start()
      ```
      ...
      # Run multiple agents
      agents = Agent4ALLAgents(agents=[diet_agent, blog_agent])
      agents.start()
      ```
    </CodeGroup>
      </Step>
...
<CardGroup cols={3}>
  ...
  <Card title="Why Choose Agent4ALL?" icon="stars">
    <CardGroup cols={2}>
## Developer First
...
## Open Source
Agent4ALL is open source and available on [GitHub](https://github.com/MervinPraison/Agent4ALL).

## Low Code User Friendly
Agent4ALL is designed to be easy to learn and use for non technical users.
    </CardGroup>
  </Card>
