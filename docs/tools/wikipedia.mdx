---
title: "Wikipedia Agent4ALL Integration"
description: "Guide for integrating Wikipedia search capabilities with Agent4ALL agents using the Wikipedia API wrapper"
icon: "book"
---

# Wikipedia Agent4ALL Integration
