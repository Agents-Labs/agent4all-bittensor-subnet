...
description: "Learn how to use LangChain tools and utilities with Agent4ALL agents."
icon: "link-simple"
---
...
agents = Agent4ALLAgents(agents=[youtube_agent, wiki_agent])
agents.start()
```
</CodeGroup>
        </Step>
...
<CardGroup cols={2}>
  <Card title="Tool Integration" icon="plug">
    Seamlessly use LangChain tools with Agent4ALL agents.
  </Card>
...
<Note>
  ...
  - Agent4ALL will automatically detect the tool and use it.
