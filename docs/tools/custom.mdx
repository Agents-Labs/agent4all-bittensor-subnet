...
description: "Step-by-step guide for creating and implementing custom tools in Agent4ALL, including examples and configuration instructions"
icon: "wrench"
---
...
## Step 1: Install the `agent4all` Package

First, you need to install the `agent4all` package. Open your terminal and run the following command:
...
## Step 4: Run the Agent4ALL Tool

To run the Agent4ALL tool, simply type the following command in your terminal:
...
That's it! You should now have the Agent4ALL tool installed and configured.
...
```bash
pip install agent4all duckduckgo-search
export OPENAI_API_KEY="Enter your API key"
agent4all --init research about the latest AI News and prepare a detailed report
```
...
If it doesn't exist, create it by running the command `agent4all --init research about the latest AI News and prepare a detailed report`.
