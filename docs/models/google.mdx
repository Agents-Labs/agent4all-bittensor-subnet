...
description: "Instructions for integrating Google's Gemini models with Agent4ALL, including API setup and configuration details"
icon: "google"
---
...
<Steps>
    <Step title="Install Package">
        First, install Agent4ALL Agents:
        ```bash
...
The simplest way to use Gemini with Agent4ALL Agents:
...
| Agent4ALL Chat | Agent4ALL Code | Agent4ALL (Multi-Agents) |
| --- | --- | --- |
