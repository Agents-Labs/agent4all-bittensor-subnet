...
description: "Learn how to use Deepseek models with Agent4ALL Agents for various applications."
icon: "brain"
---
...
Learn how to use Deepseek models with Agent4ALL Agents through Ollama integration for basic queries, RAG applications, and interactive UI implementations.
...
The simplest way to use Deepseek with Agent4ALL Agents:
