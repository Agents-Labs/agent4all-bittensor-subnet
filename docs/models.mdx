---
title: "Models in Agent4ALL"
description: "Overview of supported language models in Agent4ALL, including OpenAI, Groq, Google Gemini, Anthropic Claude, and configuration examples"
icon: "brain"
---
